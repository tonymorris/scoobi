...
object Scoobi extends core.WireFormatImplicits
  ...
  type Grouped1[K, V] = com.nicta.scoobi.core.Grouped1[K, V]
  type Iterable1[A] = com.nicta.scoobi.core.Iterable1[A]
  type Iterator1[A] = com.nicta.scoobi.core.Iterator1[A]
